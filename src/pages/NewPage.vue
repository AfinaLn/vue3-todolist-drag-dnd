            ...
            <div class="main-container">
                <div class="content-wrapper">
                    <div class="content-section">
                        ...
                        <div class="apps-card">
                            <Container class="h-full flex overflow-x-auto gap-8 p-8" group-name="cols" tag="div"
                                orientation="horizontal" @drop="onColumnDrop($event)">
                                <Draggable
                                    class="app-card dragg-wrapper-bg dark:bg-gray-700 rounded-lg h-full w-96 flex-shrink-0 shadow-xl"
                                    ...
                                    <div class="h-full flex flex-col">
                                        ...
                                        <!-- column  -->
                                        <Container class="page-content-column flex-grow overflow-y-auto overflow-x-hidden"
